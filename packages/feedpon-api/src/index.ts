...
const FEEDLY_API = {
  ...
  paths: {
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  code: {
                    type: 'string',
                    description: 'the code returned from the previous call.',
                  },
                  client_id: {
                    type: 'string',
                    description:
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    id: {
                      type: 'string',
                      description: 'the feedly user id',
                    },
                    access_token: {
                      type: 'string',
                      description:
                    ...
                    expires_in: {
                      type: 'integer',
                      description: 'the remaining lifetime on the access token',
                    },
                    token_type: {
                      type: 'string',
                      description:
                    ...
                    plan: {
                      type: 'string',
                      enum: ['standard', 'pro', 'business'],
                      description: 'indicated the user plan',
                    },
                    state: {
                      type: 'string',
                      description: 'the state that was passed in',
                    },
                  },
                },
              },
    ...
    '/auth/{refreshToken}': {
      post: {
        summary: 'Refreshing an access token',
    ...
    '/categories/{categoryId}': {
      post: {
        summary: 'Change the label of an existing category',
    ...
    '/feeds/{feedId}': {
      get: {
        summary: 'Get the metadata about a specific feed',
        operationId: 'getFeed',
        parameters: [
          {
            name: 'feedId',
    ...
    '/feeds/.mget': {
      post: {
        summary: 'Get the metadata for a list of feeds',
        operationId: 'getMultipleFeed',
        requestBody: {
          required: true,
          content: {
            'application/json': {
    ...
    '/markers/counts': {
      get: {
        summary: 'Get the list of unread counts',
    ...
    '/markers': {
      post: {
        summary: 'Mark one or multiple articles as read or saved',
            ...
            'application/json': {
              schema: {
                oneOf: [
                  ...
                  {
                    type: 'object',
                    required: ['action', 'type', 'feedIds'],
                    properties: {
                      action: {
                        type: 'string',
                        enum: ['markAsRead', 'undoMarkAsRead'],
                      },
                      type: {
                        type: 'string',
                        enum: ['feeds'],
                  ...
                  {
                    type: 'object',
                    required: ['action', 'type', 'categoryIds'],
                    properties: {
                      action: {
                        type: 'string',
                        enum: ['markAsRead', 'undoMarkAsRead'],
    ...
    '/markers/read': {
      get: {
        summary: 'Get the latest read operations (to sync local cache)',
        operationId: 'getLatestReadOperations',
        responses: {
          '200': {
            description: 'Success',
            content: {
                ...
                schema: {
                  ...
                  properties: {
                    feeds: {
                      ...
                      description:
                        'feeds that were marked as read in the time period. For each feed, the timestamp of the read marker will be returned.',
                    },
                    entires: {
                      type: 'array',
                      items: {
                    ...
                    unread: {
                      ...
                      description:
                        'the list of individual entries that were kept unread. Note: only entries before the read marker will be returned here.',
                    },
                    updated: {
                      type: 'integer',
                      format: 'int64',
    ...
    '/markers/tags': {
      get: {
        summary: 'Get the latest tagged entry ids',
        operationId: 'getLatestTaggedEntryIds',
        responses: {
          '200': {
            description: 'Success',
            content: {
    ...
    '/opml': {
      get: {
        summary: "Export the user's subscriptions as an OPML file",
    ...
    '/search': {
      get: {
        summary: 'Find feeds based on title, url or #topic',
    ...
    '/search/{streamId}/contents': {
      get: {
        summary: 'Search the content of a stream',
        ...
        parameters: [
          ...
          },
          {
            ...
            in: 'query',
            description:
              "number of entries to return. Note: if the user isn't pro, only 2 articles will be returned.",
            schema: {
              type: 'integer',
              default: 10,
              minimum: 1,
          ...
          },
          {
            name: 'newerThan',
            in: 'query',
            description: 'timestamp in ms; cannot be older than 31 days ago.',
            schema: {
              type: 'integer',
              format: 'int64',
            },
          },
          {
            ...
            in: 'query',
            description:
              'if true, only unread articles will be returned. Reminder: entries older than 31 days are automatically marked as read.',
            schema: {
              type: 'boolean',
              default: false,
            },
          ...
          },
          {
            ...
            in: 'query',
            description:
              'a comma-separated list of fields. By default, all fields are used for matching. Valid field names: `all`, `title`, `author`, `keywords`.',
            schema: {
              type: 'array',
              items: {
                type: 'string',
                enum: ['all', 'title', 'author', 'keywords'],
              },
              default: ['all'],
            },
            style: 'form',
    ...
    '/streams/{streamId}/contents': {
      get: {
        summary: 'Get the content of a stream',
        ...
        parameters: [
          ...
          },
          {
            ...
            in: 'query',
            description:
              'if true, only unread articles will be returned. Reminder: entries older than 31 days are automatically marked as read. This flag requires the authorization header. It is ignored for tag streams.',
            schema: {
              type: 'boolean',
              default: false,
            },
          ...
          },
          {
            ...
            in: 'query',
            description:
              'a continuation id is used to page through the entry ids; you can also pass a timestamp in ms, which will act as an "older than" limit.',
            schema: {
              type: 'string',
            },
          },
    ...
    '/streams/{streamId}/ids': {
      get: {
        summary: 'Get a list of entry ids for a specific stream',
        operationId: 'getEntryIds',
        parameters: [
          {
            name: 'streamId',
            in: 'path',
          ...
          },
          {
            name: 'count',
            in: 'query',
            description: 'number of entry ids to return.',
            schema: {
              type: 'integer',
              default: 20,
              minimum: 1,
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    continuation: {
                      type: 'string',
                      description:
                        'the continuation id to pass to the next stream call, for pagination. This id guarantees that no entry will be duplicated in a stream (meaning, there is no need to de-duplicate entries returned by this call). If this value is not returned, it means the end of the stream has been reached.',
                    },
                  },
                },
              },
    ...
    '/subscriptions/.mput': {
      post: {
        summary: 'Update multiple subscriptions',
        operationId: 'updateMultipleSubscriptions',
        requestBody: {
          required: true,
          content: {
            'application/json': {
    ...
    '/subscriptions/.mdelete': {
      delete: {
        summary: 'Unsubscribe from multiple feeds',
        operationId: 'unsubscribeFromMultipleFeeds',
        requestBody: {
          required: true,
          content: {
            'application/json': {
    ...
    '/tags': {
      get: {
        summary: 'Get the list of tags created by the user.',
        operationId: 'getTags',
        responses: {
          '200': {
            description: 'Success',
    ...
    '/tags/{tagId}/{entryId}': {
      ...
      delete: {
        summary: 'Untag multiple entries',
  ...
  components: {
    ...
    schemas: {
      ...
      Feed: {
        type: 'object',
        required: ['id', 'subscribers', 'title'],
        properties: {
          id: {
            type: 'string',
            description: 'the unique, immutable id of this feed.',
          },
          subscribers: {
            type: 'integer',
            description:
          ...
          website: {
            type: 'string',
            format: 'uri',
            description: 'url the website for this feed.',
          },
          topics: {
            type: 'array',
            items: {
            ...
            description:
              'an array of topics this feed covers. This list can be used in searches and mixes to build a list of related feeds and articles. E.g. if the list contains “productivity”, querying “productivity” in feed search will produce a list of related feeds.',
          },
          state: {
            type: 'string',
            enum: ['dead', 'dead.flooded', 'dead.dropped', 'dormant'],
            description:
              'only returned if the feed cannot be polled. Values include "dead" (cannot be polled), "dead.flooded" (if the feed produces too many articles per day), "dead.dropped" (if the feed has been removed), and "dormant" (if the feed hasn\'t been updated in a few months).',
          },
        },
      },
      Entry: {
        ...
        properties: {
          ...
          summary: {
            $ref: '#/components/schemas/Content',
            description: 'the article summary. See the content object above.',
          },
          author: {
            type: 'string',
          ...
          origin: {
            ...
            description: 'the feed from which this article was crawled.',
          },
          keywords: {
            type: 'array',
            items: {
          ...
          engagement: {
            type: 'integer',
            description:
              'an indicator of how popular this entry is. The higher the number, the more readers have read, saved or shared this particular entry. This value changes over time.',
          },
          engagementRate: {
            type: 'number',
            format: 'float',
            description:
              'a normalized indicator for the relative popularity of this entry compared to past data from the same source. A value below 1.0 indicates this entry is less popular, on average. A value above 1.0 indicates this entry is more popular. Because this value is normalized, it can be used to compare entries from other sources, and is used for engagement ranking. This value changes over time.',
          },
          actionTimestamp: {
            type: 'integer',
            format: 'int64',
            description:
              'a timestamp for tagged articles, contains the timestamp when the article was tagged by the user. This will only be returned when the entry is returned through the streams API.',
          },
          enclosure: {
            type: 'array',
            items: {
          ...
          sid: {
            type: 'string',
            description: 'an internal search id.',
          },
          language: {
            type: 'string',
            description: 'what is the language associated with this article.',
          },
          canonicalUrl: {
            type: 'string',
            format: 'uri',
      ...
      Origin: {
        type: 'object',
        required: ['streamId', 'title', 'htmlUrl'],
        properties: {
          streamId: {
            type: 'string',
          ...
          htmlUrl: {
            type: 'string',
            format: 'uri',
            description: 'the feed’s website.',
          },
        },
      },
      Visual: {
      ...
      Profile: {
        ...
        properties: {
          id: {
            type: 'string',
            description: 'the unique, immutable user id.',
          },
          email: {
            type: 'string',
            description:
              'the email address extracted from the OAuth profile. Not always available, depending on the OAuth method used.',
          },
          givenName: {
            type: 'string',
            description: 'the given (first) name. Not always available.',
          },
          familyName: {
            type: 'string',
            description: 'the family (last) name. Not always available.',
          },
          fullName: {
            type: 'string',
            description: 'the full name. Not always available.',
          },
          picture: {
            type: 'string',
            format: 'uri',
          ...
          locale: {
            type: 'string',
            description: 'the locale, extracted from the OAuth profile.',
          },
          google: {
            type: 'string',
            description:
          ...
          reader: {
            type: 'string',
            description:
              ' the Google Reader user id. If present, this indicates a user who migrated from Google Reader.',
          },
          twitterUserId: {
            type: 'string',
            description:
          ...
          wave: {
            type: 'string',
            description:
              'the analytics "wave". Format is: "yyyy.ww" where yyyy is the year, ww is the week number. E.g. "2014.02" means this user joined on the second week of 2014. See http://www.epochconverter.com/date-and-time/weeknumbers-by-year.php for week number definitions.',
          },
          client: {
            type: 'string',
            description: 'the client application used to create this account.',
          },
          source: {
            type: 'string',
            description: 'the client name/version used to create this account.',
          },
          created: {
            type: 'integer',
            format: 'int64',
      ...
      SearchResult: {
        type: 'object',
        required: ['feedId', 'subscribers', 'title'],
        properties: {
          feedId: {
            type: 'string',
            description: 'the unique, immutable id of this feed.',
          ...
          website: {
            type: 'string',
            description: 'the website associated with this feed.',
          },
          lastUpdated: {
            type: 'integer',
            format: 'int64',
          ...
          language: {
            type: 'string',
            description:
              'a combination of the language reported by the RSS feed, and the language automatically detected from the feed’s content. It might not be accurate, as many feeds misreport it.',
          },
          featured: {
            type: 'boolean',
            description:
          ...
          iconUrl: {
            type: 'string',
            format: 'uri',
            description: 'a small (square) icon URL',
          },
          visualUrl: {
            type: 'string',
            format: 'uri',
            description: 'a larger (square) icon URL',
          },
          coverUrl: {
            type: 'string',
            format: 'uri',
            description: 'a large (rectangular) background image',
          },
          logo: {
            type: 'string',
            format: 'uri',
            description: 'a small (square) icon URL with transparency',
          },
          contentType: {
            type: 'string',
            description:
              'the auto-detected type of entries this feed publishes. Values include "article" (most common), "longform" (for longer article), "videos" (for YouTube, Vimeo and other video-centric feeds), and "audio" (for podcast feeds etc).',
          },
          coverColor: {
            type: 'string',
            description: 'the background cover color',
          },
        },
      },
      Stream: {
        ...
        properties: {
          id: {
            type: 'string',
            description: 'the stream id, repeated.',
          },
          updated: {
            type: 'integer',
            format: 'int64',
            description:
              'the timestamp, in ms, of the most recent entry for this stream (regardless of continuation, newerThan, etc).',
          },
          continuation: {
            type: 'string',
            description:
          ...
          title: {
            type: 'string',
            description: 'for single feeds only, the feed title.',
          },
          direction: {
            $ref: '#/components/schemas/Direction',
            description:
              'for single feeds only, the text direction ("ltr" for left-to-right languages, "rtl" for right-to-left languages).',
          },
          alternate: {
            $ref: '#/components/schemas/Link',
            description:
