...
> {
  ...
  private _handleChangeNumStreamHistories = (
  ...
  private _handleChangeCacheCapacity = (
    event: React.ChangeEvent<HTMLInputElement>,
  ): void => {
  ...
  private _handleChangeFetchOptions = (
    event: React.ChangeEvent<HTMLInputElement>,
  ): void => {
  ...
  private _handleChangeStreamView = (
    event: React.ChangeEvent<HTMLInputElement>,
  ): void => {
  ...
  private _handleSubmitFetchOptions = (
  ...
  private _handleSubmitStreamView = (
    event: React.FormEvent<HTMLFormElement>,
  ): void => {
    event.preventDefault();
  ...
  private _handleSubmitHistoryOptions = (
    event: React.FormEvent<HTMLFormElement>,
  ): void => {
    event.preventDefault();
  ...
  private _handleSubmitCacheCapacity = (
    event: React.FormEvent<HTMLFormElement>,
  ): void => {
    event.preventDefault();
