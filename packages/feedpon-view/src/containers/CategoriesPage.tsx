...
> {
  ...
  private _renderContent() {
    ...
    const description =
      subscriptions.length > 0 ? (
        <p>
          <strong>{subscriptions.length}</strong> subscriptions are available in
          this category.
        </p>
      ) : (
  ...
  private _handleChangeSearchQuery = debounce(
  ...
  private _handleChangeUploadFile = (
