...
import { addToCategory, importOpml, removeFromCategory, unsubscribe } from 'feedpon-messaging/subscriptions';
import { createCategory, deleteCategory, updateCategory } from 'feedpon-messaging/categories';
...
class CategoriesPage extends PureComponent<CategoriesPageProps, CategoriesPageState> {
    ...
    private _handleChangeSearchQuery = debounce((_event: React.ChangeEvent<HTMLInputElement>) => {
        if (!this.searchInput) {
            return;
        }
...
export default connect(() => {
    ...
    const activeCategorySelector = createSelector(
        categoriesSelector,
        (_state: State, props: CategoriesPageProps) => props.match.params['label'],
