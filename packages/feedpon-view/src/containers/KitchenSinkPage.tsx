    ...
    <MainLayout header={navbar}>
      <div className="container">
        ...
        <p>
          ...
          <br />
          <span className="u-text-positive">
        ...
        <div className="button-toolbar u-margin-bottom-2">
          ...
          <span className="badge badge-small badge-pill badge-positive">
            34
          </span>
          <span className="badge badge-small badge-pill badge-negative">
            56
          </span>
          <span className="badge badge-medium badge-pill badge-default">
            12
          </span>
          <span className="badge badge-medium badge-pill badge-positive">
            34
          </span>
          <span className="badge badge-medium badge-pill badge-negative">
            56
          </span>
          <span className="badge badge-large badge-pill badge-default">12</span>
          <span className="badge badge-large badge-pill badge-positive">
            34
          </span>
          <span className="badge badge-large badge-pill badge-negative">
            56
          </span>
        </div>
        <h2>Paragraph</h2>
        ...
        <div className="u-margin-bottom-2">
          <nav className="nav">
            ...
            <a className="nav-item is-selected" href="#">
              Second
            </a>
            <a className="nav-item" href="#">
              Third
