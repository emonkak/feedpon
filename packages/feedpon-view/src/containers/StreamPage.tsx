...
import type { Category, Entry, EntryOrderKind, State, Stream, StreamViewKind, Subscription } from 'feedpon-messaging';
import { addToCategory, removeFromCategory, subscribe, unsubscribe } from 'feedpon-messaging/subscriptions';
import { changeActiveEntry, changeExpandedEntry, resetReadEntry, changeStreamView, selectStream, unselectStream } from 'feedpon-messaging/ui';
import { changeUnreadKeeping, fetchEntryComments, fetchFullContent, fetchMoreEntries, fetchStream, hideEntryComments, hideFullContents, markAllAsRead, markAsRead, markCategoryAsRead, markFeedAsRead, pinEntry, showEntryComments, showFullContents, unpinEntry, updateEntryHeights } from 'feedpon-messaging/streams';
import { createCategory, createSortedCategoriesSelector } from 'feedpon-messaging/categories';
...
export default connect(() => {
    ...
    const streamSelector = createSelector(
        ...
        (_state: State, props: StreamPageProps) => decodeURIComponent(props.match.params['stream_id']),
