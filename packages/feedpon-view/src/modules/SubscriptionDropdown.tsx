...
export default class SubscriptionDropdown extends PureComponent<
  SubscriptionDropdownProps,
  SubscriptionDropdownState
> {
  constructor(props: SubscriptionDropdownProps) {
    ...
    this.handleCloseUnsubscribeModal =
      this.handleCloseUnsubscribeModal.bind(this);
    this.handleCreateCategory = this.handleCreateCategory.bind(this);
    this.handleOpenUnsubscribeModal =
      this.handleOpenUnsubscribeModal.bind(this);
  ...
  renderCategoryMenuItem(category: Category) {
    ...
    return (
      <MenuItem
        ...
        onSelect={
          isAdded ? this.handleRemoveFromCategory : this.handleAddToCategory
        }
