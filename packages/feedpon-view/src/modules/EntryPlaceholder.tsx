...
export const ExpandedEntryPlaceholder: React.FC<ExpandedEntryPlaceholderProps> = () => {
    return (
...
export const CollapsedEntryPlaceholder: React.FC<CollapsedEntryPlaceholderProps> = () => {
    return (
