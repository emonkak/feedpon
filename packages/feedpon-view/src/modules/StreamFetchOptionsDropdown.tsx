...
export default class StreamFetchOptionsDropdown extends PureComponent<
  StreamFetchOptionsDropdownProps,
  StreamFetchOptionsDropdownState
> {
  constructor(props: StreamFetchOptionsDropdownProps) {
    ...
    this.handleSubmitNumberOfEntries =
      this.handleSubmitNumberOfEntries.bind(this);
  }

  handleSubmitNumberOfEntries(_event: React.FormEvent<HTMLFormElement>) {
