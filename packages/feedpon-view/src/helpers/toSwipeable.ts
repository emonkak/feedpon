...
export default function toSwipeable<TProps>(Component: React.ComponentType<WithChildren<TProps> & SwipeableProps>): React.ComponentType<WithChildren<TProps>> {
    return class Swipeable extends PureComponent<WithChildren<TProps>, SwipeableState> {
