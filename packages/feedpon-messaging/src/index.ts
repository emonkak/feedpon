...
import type { Store as FluxStore } from 'feedpon-utils/flux/types';
...
export type Event =
  ...
  | {
      ...
      bookmarkCounts: { [url: string]: number };
    }
  ...
  | {
      ...
      readCounts: { [streamId: string]: number };
    }
...
export interface Selectors {
  ...
  groupedSubscriptionsSelector: (state: State) => {
