...
export const VOID_ELEMENTS = keyMirror([
  'area',
  'br',
  'col',
  'hr',
...
export const OPTIONAL_END_TAG_ELEMENTS = keyMirror([
  'colgroup',
  'dd',
  'dt',
  'li',
...
export const BLOCK_ELEMENTS = keyMirror([
  'address',
  'article',
  'aside',
  'blockquote',
...
export const INLINE_ELEMENTS = keyMirror([
  'a',
  'abbr',
  'acronym',
  'audio',
...
export const URI_ATTRS = keyMirror([
  'background',
  'cite',
  'href',
  'longdesc',
...
export const HTML_ATTRS = keyMirror([
  'abbr',
  'accesskey',
  'align',
  'alt',
