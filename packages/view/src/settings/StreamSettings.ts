...
import type { EntryRanking, StreamLayout } from '@feedpon/model';
import { AppStore } from '@feedpon/model';
import * as streamActions from '@feedpon/model/actions/stream';
import { openAlertDialog } from '@feedpon/primitives';
      ...
      <section class="section">
        ...
        <form class="form" @submit=${handleDefaultSessionSettingsUpdate}>
          ...
          <div class="form-group">
            ...
            ${(['engagement', 'newest', 'oldest'] satisfies EntryRanking[]).map(
              (value) => html`
