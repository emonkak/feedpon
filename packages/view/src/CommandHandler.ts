import type { AppAction } from '@feedpon/model';
import { type CommandHandler, getEntryUrl } from '@feedpon/model';
import {
  expandEntry,
  ...
  toggleStreamLayout,
} from '@feedpon/model/actions/stream';
import { reloadSubscriptions } from '@feedpon/model/actions/subscription';
import {
  showOsd,
  toggleKeyboardShortcuts,
  toggleSidebar,
} from '@feedpon/model/actions/ui';
