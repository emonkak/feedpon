import type { Category, Feed, Subscription } from '@feedpon/model';
...
export const SubscriptionSettingsDropdown =
  createComponent<SubscriptionSettingsDropdownProps>(
    function SubscriptionSettingsDropdown({
      ...
      const handleChangeCategoryLabel = this.useCallback((event: Event) => {
                ...
                const handleAction = async () => {
                  const newLabels = isAdded
                    ? (subscription.categories
                        .map(
                          (subscriptionCategory) => subscriptionCategory.label,
                        )
                        .filter(
                          (label) =>
            ...
            childItems: [
              {
                ...
                children: html`
                  <div class="MenuItem-content"> <div class="input-group">
                      <input
                        type="text"
                        class="form-control"
                        style="width: 12ch"
