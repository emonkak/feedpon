...
export default function toPopup<TProps>(
    PopupComponent: React.ComponentType<TProps & PopupProps>,
    ...
    return class Popup extends PureComponent<TProps, PopupState> {
        ...
        private _openPopup = (): void => {
            ...
            const pullDirection = getFittedPullDirection(containerRect, viewportWidth, viewportHeight, pullDirections);
...
function getPopupStyle(containerRect: ClientRect, pullDirection: PullDirection): React.CSSProperties {
