...
import InjectionPolicy from './shared/di/injectionPolicies/InjectionPolicy';
...
import LocalForageRedirectionRepository from './services/urlExpander/LocalForageRedirectionRepository';
...
import singletonScope from './shared/di/scopes/singletonScope';
...
class Factries {
    @Inject
    static createContentFinder(ldrFullFeedContentFinder: LdrFullFeedContentFinder, autoPagerizeContentFinder: AutoPagerizeContentFinder): IContentFinder {
...
container.bind(IRedirectionRepository).to(LocalForageRedirectionRepository);
...
container.factory(IContentFinder, Factries.createContentFinder);
