...
import UrlReplacementItem from 'view/modules/UrlReplacementItem';
import bindActions from 'utils/flux/bindActions';
import connect from 'utils/flux/react/connect';
import { State, UrlReplacement } from 'messaging/types';
import { addUrlReplacement, deleteUrlReplacement, resetUrlReplacements, updateUrlReplacement } from 'messaging/urlReplacements/actions';
...
class UrlReplacementSettings extends PureComponent<UrlReplacementSettingsProps, UrlReplacementSettingsState> {
    ...
    render() {
        ...
        return (
            <section className="section">
                ...
                <p>These rules replace matched entry URLs. If there are multiple matchs in rules, them are applied to all. Thereby you can get the correct number of bookmarks.</p>
                <UrlReplacementForm
                ...
                <div className="form">
                    <button
                        ...
                        onClick={this._handleStartResetting}>Reset all URL replacement rules</button>
                </div>
                <ConfirmModal
